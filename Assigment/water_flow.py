# Prove Milestone: Water Pressure assignment by Chris Kofi Owusu
# This program calculates water pressure at a household based on tower height, pipe properties, and flow conditions.
# The program creatively combines physics equations with real-world constraints for accurate modeling.

# Constants
# These constants represent physical properties of water and gravity, essential for pressure calculations.
EARTH_ACCELERATION_OF_GRAVITY = 9.80665  # Acceleration due to Earth's gravity (m/s²)
WATER_DENSITY = 998.2  # Density of water (kg/m³) at ~20°C
WATER_DYNAMIC_VISCOSITY = 0.0010016  # Dynamic viscosity of water (Pa·s)
